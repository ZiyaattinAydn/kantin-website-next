...
const resources: readonly AdminResource[] = [
  ...
  },
  {
    ...
    allowArchive: true,
    allowHardDelete: false,
    hardDeleteProtectionReason: "İçerik blokları sitenin sabit bölüm yapısını temsil eder. Yeni blok oluşturma panelden kapalı olduğu için kalıcı silme geri getirilemeyen bir bölüm kaybına yol açabilir; kullanılmayan bloğu pasife al veya arşivle.",
    activeField: "is_active",
    statusField: "status",
    revisionHistory: true,
    fields: [
